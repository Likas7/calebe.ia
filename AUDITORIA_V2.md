# Auditoria de Código — CALEB.IA (Versão 2)
...
**Problema:** Treino D do protocolo 02 parece ter definição incompleta comparado com A, B, C.
...
| 6 | `index.html` | Prompt menciona deload mas não реализует | Adicionar verificação automática de Borg |
